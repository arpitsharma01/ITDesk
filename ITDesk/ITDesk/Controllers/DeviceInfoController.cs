...
namespace ITDesk.Controllers
{
    ...
    public class DeviceInfoController : ControllerBase
    {
        ...
        public ActionResult allocate(int id, [FromBody] DeviceInfo device)
        {
            ...
            // QRCode functionality STARTS here
            QRCodeWriter.CreateQrCode(deviceInfo.UniqueCode, 500, QRCodeWriter.QrErrorCorrectionLevel.Medium).SaveAsPng("MyQR.png");
            string base64String = ImageToBase64("MyQR.png");
            deviceInfo.QrCode = base64String;
            // QRCode funcitonality ENDS here
